...
mentor_reviewer_1.rate_hw_student(student_2, 'Python', 6)
...
student_1.rate_hw_lecturer(mentor_lecturer_1, 'Python', 10)
student_1.rate_hw_lecturer(mentor_lecturer_1, 'Python', 8)
...
student_2.rate_hw_lecturer(mentor_lecturer_2, 'Git', 7)
...
print(f'Оценки студента {student_1.name} {student_1.surname}: ', *[f"{key}: {', '.join(map(str, value))}" for key, value in student_1.grades.items()])
print(f'Оценки студента {student_2.name} {student_2.surname}: ', *[f"{key}: {', '.join(map(str, value))}" for key, value in student_2.grades.items()])
...
print(f'Оценки лектора {mentor_lecturer_1.name} {mentor_lecturer_1.surname}: ', *[f"{key}: {', '.join(map(str, value))}" for key, value in mentor_lecturer_1.grades_lecturer.items()])
print(f'Оценки лектора {mentor_lecturer_2.name} {mentor_lecturer_2.surname}: ', *[f"{key}: {', '.join(map(str, value))}" for key, value in mentor_lecturer_2.grades_lecturer.items()])
print()
